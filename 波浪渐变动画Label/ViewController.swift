...
class ViewController: UIViewController {
    ...
    private func setupExamples() {
        // 示例1：水平方向
        let horizontalLabel = WaveGradientLabelView(frame: CGRect(x: 20, y: 100, width: view.bounds.width - 40, height: 60))
        ...
        // 示例2：垂直方向
        let verticalLabel = WaveGradientLabelView(frame: CGRect(x: 20, y: 200, width: view.bounds.width - 40, height: 60))
        ...
        // 示例3：左上到右下
        let diagonalLabel1 = WaveGradientLabelView(frame: CGRect(x: 20, y: 300, width: view.bounds.width - 40, height: 60))
        ...
        // 示例4：右上到左下
        let diagonalLabel2 = WaveGradientLabelView(frame: CGRect(x: 20, y: 400, width: view.bounds.width - 40, height: 60))
        ...
        // 示例5：跑马灯效果
        let marqueeLabel = WaveGradientLabelView(frame: CGRect(x: 20, y: 500, width: view.bounds.width - 40, height: 60))
        ...
        marqueeLabel.marqueeSpeed = 10    // 滚动速度（秒）
